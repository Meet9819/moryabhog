	...
	<div class="main-content">
		...
		<div class="col-lg-12 col-xs-12">
				<div class="box-content card white">
					<h4 class="box-title">Edit Receipe</h4>
					<!-- /.box-title -->
...
<?php
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT img,name,description,title,detail FROM blogs WHERE id =:id');
    ...
    if(isset($_POST['btn_save_updates']))
    {
        ...
        if(!isset($errMSG))
        {
             $stmt = $DB_con->prepare('UPDATE blogs SET name=:name,img=:img,description=:description,title=:title,detail=:detail WHERE id=:id');
