  ...
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
 		...
 		<div class="form-group">
								...
								<div class="col-sm-6"> 
									  ...
									  <img src="../media/testimonials/<?php echo $img; ?>" height="70" width="150" />
					       ...
					       <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="star" class="form-control" id="" placeholder="Enter star" required="" value="<?php echo $star; ?>">
                                </div>
                            </div>
