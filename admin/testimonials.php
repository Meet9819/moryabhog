...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $image_name= addslashes($_FILES['image']['name']);
            ...
            move_uploaded_file($_FILES["image"]["tmp_name"],"../media/testimonials/" . $_FILES["image"]["name"]);
  ...
  $name = $_POST['name'];
    ...
    $post = $_POST['post'];
      ...
      $star = $_POST['star'];
            ...
            $save=mysqli_query($con,"INSERT INTO testimonials (img,name,post,message,star) VALUES ('$img','$name','$post','$message','$star')");
  ...
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="number" name="star" class="form-control" id="" placeholder="Enter star" required="">
								</div>
							</div>
						...
						<tbody>
							<tr>
								 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:100px" src="../media/testimonials/'.$row['img'].'"></td>
								<td>'.$row['name'].'</td>
							<td>'.$row['post'].'</td>
								<td>'.$row['message'].'</td> 
