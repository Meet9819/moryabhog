...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $image_name= addslashes($_FILES['image']['name']);
            ...
            move_uploaded_file($_FILES["image"]["tmp_name"],"../media/team/" . $_FILES["image"]["name"]);
 ...
 $name = $_POST['name'];
 	 $designation = $_POST['designation']; 
            ...
            $save=mysqli_query($con,"INSERT INTO team (img,name,designation) VALUES ('$img','$name','$designation')");
...
?>
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="form-group">
								...
								<p class="help-block">Image should be 500 x 250 in pixels</p>
								</div>
							...
							<div class="form-group">
								<label for="inp-type-1" class="col-sm-3 control-label">name of Person</label>
								<div class="col-sm-6">
						...
						<tbody>
							<tr>
								 ';?>
                                                    ...
                                                    <?php echo '
							<td><img style="width:100px" src="../media/team/'.$row['img'].'"></td>
									<td>'.$row['name'].'</td>
